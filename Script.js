const body = document.querySelector("body");const swalst = Swal.mixin({timer: 2300, allowOutsideClick: false, showConfirmButton: false, timerProgressBar: true, imageHeight: 90,}); audio = new Audio('' + linkmp3.src); ftganti=0;fungsi=0;fungsiAwal=0;deffotostiker=fotostiker.src;
  ...
  async function inipesan(){
    ...
    vketikutama="VC ACEITA SER MINHA NMR NATHALY?? 😊";
    mulainama();
  }
  ...
  new TypeIt("#pesan4", {
  strings: ["" + vketik4], startDelay: 1, speed: 35, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  fthilang();ftganti=2;setTimeout(ftmuncul,300);
  new TypeIt("#pesan5", {
  strings: ["" + vketik5], startDelay: 1, speed: 35, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan6", {
  strings: ["" + vketik6], startDelay: 1, speed: 35, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan7", {
  strings: ["" + vketik7], startDelay: 1, speed: 35, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
  ...
  new TypeIt("#pesan8", {
  strings: ["" + vketik8], startDelay: 1, speed: 35, cursor: true, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
